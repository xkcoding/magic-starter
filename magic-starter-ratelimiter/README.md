<h1 align="center"><a href="https://github.com/xkcoding/magic-starter/magic-starter-ratelimiter" target="_blank">magic-starter-ratelimiter</a></h1>
<p align="center">
<a href="https://travis-ci.com/xkcoding/magic-starter" target="_blank"><img alt="Travis-CI" src="https://travis-ci.com/xkcoding/magic-starter.svg?branch=master"/></a>
  <a href="https://search.maven.org/artifact/com.xkcoding/magic-starter-ratelimiter" target="_blank"><img alt="MAVEN" src="https://img.shields.io/maven-central/v/com.xkcoding/magic-starter-ratelimiter.svg?color=brightgreen&label=Maven%20Central"></a>
...
`magic-starter-ratelimiter` 主要是提供了限流的相关功能，提供 2 种实现方式，一种基于 Guava，一种基于 Redis。
