 ...
 *
 * @author yangkai.shen
 * @date Created in 2019/12/18 10:32
 */
public class UuidUtil {
	...
	public static String UU16(java.util.UUID uu) {
		return StrUtil.fillBefore(Long.toHexString(uu.getMostSignificantBits()), '0', 16) + StrUtil.fillBefore(Long.toHexString(uu.getLeastSignificantBits()), '0', 16);
	}
		...
		for (int i = 0; i < length; i++) {
			...
			switch (index) {
				...
				case 1:
					...
					break;
				case 2:
					// 保证只会产生ASCII为65~90(A~Z)之间的整数（caseSensitivity为true的时候, 才会有大写字母）
